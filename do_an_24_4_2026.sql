...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '276a749b-b97c-11f0-a025-33016a13216d:1-1060';
...
INSERT INTO `appointments` VALUES (1,4,1,'2026-05-01 22:03:00','Tôi muốn lái thử chiếc xe VF 3','Scheduled','2026-04-23 14:04:26'),(2,4,1,'2026-05-02 08:20:00','test','Scheduled','2026-04-23 14:20:54');
...
INSERT INTO `car_images` VALUES (1,1,'/uploads/e4d46390-d03f-426d-8ab0-ba070a1a7c52.jpg','main',1,'2026-04-12 09:00:39'),(2,1,'/uploads/e590eeba-d583-464f-99f7-83c7ed061524.webp','gallery',2,'2026-04-12 09:00:39'),(3,1,'/uploads/eeae6bd6-3396-492f-9ac2-c6dd79075d06.jpg','gallery',3,'2026-04-12 09:00:39'),(4,2,'/uploads/a0ccaf1d-37f7-48f0-9209-017928f4a0d1.jpg','main',1,'2026-04-12 09:00:39'),(5,2,'/uploads/3350cd66-bc33-4fb3-96e7-6325b03ce400.webp','gallery',2,'2026-04-12 09:00:39'),(6,3,'/uploads/d14c1044-2212-4ddb-a63f-1067d1711307.jpg','main',1,'2026-04-12 09:00:39'),(7,4,'/uploads/b19d2a48-efbe-4493-ad09-dfaff2b3add4.jpg','main',1,'2026-04-12 09:00:39'),(8,5,'/uploads/bd43e74c-6a8e-4589-b974-b6583b47ded8.jpg','main',1,'2026-04-12 09:00:39'),(9,6,'/uploads/89e1103d-4ab3-4255-8594-e820ef774ba8.jpg','main',1,'2026-04-12 09:00:39'),(10,7,'/uploads/d65f68a9-c410-4f1e-bea0-d1a8427aae7b.jpeg','main',1,'2026-04-12 09:00:39'),(11,8,'/uploads/7e366c45-2fbb-4347-b055-9ebe91f81a27.jpg','main',1,'2026-04-12 09:00:39'),(12,9,'/uploads/7cc658a2-4828-4762-822f-708c33038148.jpg','main',1,'2026-04-12 09:00:39'),(13,10,'/uploads/1ac69a2c-c16d-4165-9b55-e8d8e8cb100f.jpg','main',1,'2026-04-12 09:00:39'),(14,11,'/uploads/4380f983-98f3-4e1d-86a6-5cffc190856a.webp','main',1,'2026-04-12 09:00:39');
...
CREATE TABLE `dealer_inventory` (
  ...
  KEY `dai_ly_id` (`dai_ly_id`),
  KEY `xe_id` (`xe_id`),
  KEY `fk_inventory_version` (`phien_ban_id`),
  ...
  CONSTRAINT `fk_inventory_version` FOREIGN KEY (`phien_ban_id`) REFERENCES `car_versions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dealer_inventory` VALUES (1,1,1,1,10,0,5,'2026-04-13 04:31:52'),(2,1,2,3,10,0,5,'2026-04-13 04:31:52'),(3,1,3,4,10,0,5,'2026-04-13 04:31:52'),(4,1,4,6,10,0,5,'2026-04-13 04:31:52'),(5,1,5,8,10,0,5,'2026-04-13 04:31:52'),(6,1,6,10,10,0,5,'2026-04-13 04:31:52'),(7,1,7,12,10,0,5,'2026-04-13 04:31:52'),(8,1,8,13,10,0,5,'2026-04-13 04:31:52'),(9,1,9,14,10,0,5,'2026-04-13 04:31:52'),(10,1,10,15,10,0,5,'2026-04-13 04:31:52'),(11,1,11,16,10,0,5,'2026-04-13 04:31:52');
...
CREATE TABLE `order_items` (
  ...
  KEY `fk_order_item_version` (`phien_ban_id`),
  CONSTRAINT `fk_order_item_version` FOREIGN KEY (`phien_ban_id`) REFERENCES `car_versions` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO `order_items` VALUES (1,1,1,1,'{\"loaiPin\": \"LFP 18.64 kWh\", \"mauNoiThat\": \"Đen\", \"phienBanId\": \"1\", \"loaiNoiThat\": \"Standard\", \"mauNgoaiThat\": \"Trắng\"}',302000000.00,1),(2,1,2,3,'{\"loaiPin\": \"LFP 37.23 kWh\", \"mauNoiThat\": \"Xám\", \"phienBanId\": \"3\", \"loaiNoiThat\": \"Premium\", \"mauNgoaiThat\": \"Đỏ\"}',529000000.00,1),(3,2,1,2,'{\"loaiPin\": \"LFP 18.64 kWh\", \"mauNoiThat\": \"Đen\", \"phienBanId\": \"1\", \"loaiNoiThat\": \"Standard\", \"mauNgoaiThat\": \"Trắng\"}',302000000.00,1),(4,3,1,1,'{\"loaiPin\": \"LFP 18.64 kWh\", \"mauNoiThat\": \"Đen\", \"phienBanId\": \"1\", \"loaiNoiThat\": \"Standard\", \"mauNgoaiThat\": \"Trắng\"}',302000000.00,1);
...
INSERT INTO `order_status_history` VALUES (1,1,'Confirmed',1,'2026-04-12 20:17:59'),(2,1,'InProduction',1,'2026-04-12 20:18:09'),(3,1,'Confirmed',1,'2026-04-12 20:18:23'),(4,2,'Confirmed',1,'2026-04-12 22:53:16'),(5,3,'Confirmed',1,'2026-04-19 07:10:04'),(6,3,'Delivered',1,'2026-04-19 07:10:11'),(7,1,'Confirmed',1,'2026-04-23 00:22:51'),(8,1,'InProduction',1,'2026-04-23 00:24:12'),(9,1,'Confirmed',1,'2026-04-23 00:25:15');
...
INSERT INTO `orders` VALUES (1,1,1,'Confirmed',166200000.00,831000000.00,'2026-04-12 19:44:18','2026-04-23 00:25:15'),(2,4,1,'Confirmed',60400000.00,302000000.00,'2026-04-12 22:52:47','2026-04-12 22:53:16'),(3,5,1,'Confirmed',60400000.00,302000000.00,'2026-04-19 07:07:03','2026-04-19 07:10:11');
...
-- Dump completed on 2026-04-24 11:07:18
