        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-orange-300 text-black">
              ...
              <th className="p-4">Thông tin Xe & Phiên bản</th>
            ...
            {inventory.map(item => {
              ...
              return (
                <tr key={item.id} className="hover:bg-blue-50/30 transition-colors">
                  ...
                  <td className="p-5">
                    <div className="font-black text-blue-900 text-lg uppercase">{item.mauXe}</div>
                    <div className="inline-block mt-1 px-2 py-0.5 bg-blue-100 text-blue-700 text-[10px] font-bold rounded uppercase">
                       {item.tenPhienBan}
                    </div>
                  </td>
